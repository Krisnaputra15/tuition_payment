    ...
    <div class="container">
      <div class="header-row">
        <div class="header-column justify-content-start"> 
          ...
          <!-- Logo
          ============================================= -->
          <div class="logo"> <a href="{{url('/siswa')}}" class="d-flex" title="Quickai - HTML Template"><img src="{!! asset('images/logo.png') !!}" alt="Quickai"></a> </div>
          <!-- Logo end --> 
        ...
        <div class="header-column justify-content-end"> 
          ...
          <nav class="primary-menu navbar navbar-expand-lg">
            <div id="header-nav" class="collapse navbar-collapse">
              <ul class="navbar-nav">
                <li> <a class="dropdown-toggle" href="{{url('/siswa')}}">Profile<i class="arrow"></i></a>
            </div>
          </nav>
