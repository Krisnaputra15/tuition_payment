    ...
    <div class="container">
      <div class="bg-light shadow-md rounded p-4">
        ...
        @endif
                    ...
                    <form id="signupForm" method="post" action="{{url('/petugas/student/edit-process')}}">
            @csrf
        ...
        <div class="tab-content my-3" id="myTabContent">
          <div class="tab-pane fade show active" id="first" role="tabpanel" aria-labelledby="first-tab">
            ...
            @if($spp1count != 0)
              <table class="table table-hover border">
                ...
                @foreach($spp1 as $s)
                  <tr>
                    ...
                    <td class="text-center text-right">
                        <a class="btn btn-success btn-sm" href="{{url('/petugas/spp-'.$s->id_pembayaran.'/confirm')}}">Confirm</a>
                    </td>
                  </tr>
                @endforeach
                @else
                <tr>
                    ...
                    <td class="text-center">
                        <a class="btn btn-success btn-sm" href="{{url('/petugas/spp-'.$spp1->id_pembayaran.'/confirm')}}">Confirm</a>
                    </td>
                  </tr>
                @endif
                </tbody>
              ...
              @endif
              @else
              <h6 style="color:green;"><b>{{$siswa->nama}} does not have any tuition fees dependents</b></h6>
              @endif
            </div>
          </div>
          ...
          @if($spp2count != 0)
              <table class="table table-hover border">
                ...
                @foreach($spp2 as $s)
                  <tr>
                    ...
                    @endif  
                        <a class="btn btn-success btn-sm" href="{{url('/petugas/spp-'.$s->id_pembayaran.'/confirm')}}">Confirm</a>
                        <a class="btn btn-danger btn-sm" href="{{url('/petugas/spp-'.$s->id_pembayaran.'/unconfirm')}}">Decline</a>
                    </td>
                  </tr>
                @endforeach
                @else
                <tr>
                    ...
                    <a class="btn btn-danger btn-sm" href="#">No Payment Slip</a> 
                    @endif  
                        <a class="btn btn-success btn-sm" href="{{url('/petugas/spp-'.$spp2->id_pembayaran.'/confirm')}}">Confirm</a>
                        <a class="btn btn-danger btn-sm" href="{{url('/petugas/spp-'.$spp2->id_pembayaran.'/unconfirm')}}">Decline</a>
                    </td>
                  </tr>
                @endif
                </tbody>
              ...
              @endif
              @else
              <center><h6 style="color:grey;"><b>{{$siswa->nama}} does not have any tuition fees dependents which need to be verified</b></h6></center>
              @endif
            </div>
          </div>
          <div class="tab-pane fade" id="third" role="tabpanel" aria-labelledby="third-tab">
            ...
            @if($spp3count != 0)
              <table class="table table-hover border">
                ...
                @foreach($spp3 as $s)
                  <tr>
                    ...
                    @endif  
                        <a class="btn btn-danger btn-sm" href="{{url('/petugas/spp-'.$s->id_pembayaran.'/unconfirm')}}">Unconfirm</a>
                    </td>
                  </tr>
                @endforeach
                @else
                <tr>
                    ...
                    <a class="btn btn-primary btn-sm" href="#">No Payment Slip</a> 
                    @endif  
                        <a class="btn btn-danger btn-sm" href="{{url('/petugas/spp-'.$spp3->id_pembayaran.'/unconfirm')}}">Unconfirm</a>
                    </td>
                  </tr>
                @endif
                </tbody>
              ...
              @endif
              @else
              <center><h6 style="color:red;"><b>{{$siswa->nama}} has not paid any tuition fees</b></h6></center>
              @endif
            </div>
          </div>
