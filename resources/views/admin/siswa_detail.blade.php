...
<!-- Page Header
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-8">
          <h1>Student {{$siswa->nama}}'s page</h1>
        </div>
        <div class="col-md-4">
    ...
    <div class="container">
      <div class="bg-light shadow-md rounded p-4">
        <div class="row">
          <div class="col-md-3">
            <ul class="nav nav-tabs flex-column" id="myTab" role="tablist">
              ...
              <li class="nav-item"> <a class="nav-link" id="second-tab" data-toggle="tab" href="#secondTab" role="tab" aria-controls="secondTab" aria-selected="false">Tuition Fee Dependents</a> </li>
            </ul>
          </div>
          <div class="col-md-9">
        ...
        <div class="tab-content my-3" id="myTabContent">
              ...
              <table class="table table-hover border">
                ...
                @foreach($spp1 as $s)
                  <tr>
                    ...
                    <td class="text-center text-right">
                        <a class="btn btn-success btn-sm" href="{{url('/admin/spp-'.$s->id_pembayaran.'/confirm')}}">Confirm</a>
                        <a class="btn btn-warning btn-sm" href="{{url('/admin/spp-'.$s->id_pembayaran.'/edit')}}">Edit</a>
                        <a class="btn btn-danger btn-sm" href="{{url('/admin/spp-'.$s->id_pembayaran.'/delete')}}">Delete</a>
                    </td>
                  </tr>
                @endforeach
                @else
                <tr>
                    ...
                    <td class="text-center">
                        <a class="btn btn-success btn-sm" href="{{url('/admin/spp-'.$spp1->id_pembayaran.'/confirm')}}">Confirm</a>
                        <a class="btn btn-warning btn-sm" href="{{url('/admin/spp-'.$spp1->id_pembayaran.'/edit')}}">Edit</a>
                        <a class="btn btn-danger btn-sm" href="{{url('/admin/spp-'.$spp1->id_pembayaran.'/delete')}}">Delete</a>
                    </td>
                  </tr>
                @endif
                </tbody>
              ...
              <table class="table table-hover border">
                ...
                @foreach($spp2 as $s)
                  <tr>
                    ...
                    @endif  
                        <a class="btn btn-success btn-sm" href="{{url('/admin/spp-'.$s->id_pembayaran.'/confirm')}}">Confirm</a>
                        <a class="btn btn-success btn-sm" href="{{url('/admin/spp-'.$s->id_pembayaran.'/unconfirm')}}">Decline</a>
                        <a class="btn btn-warning btn-sm" href="{{url('/admin/spp-'.$s->id_pembayaran.'/edit')}}">Edit</a>
                        <a class="btn btn-danger btn-sm" href="{{url('/admin/spp-'.$s->id_pembayaran.'/delete')}}">Delete</a>
                    </td>
                  </tr>
                ...
                <tr>
                    ...
                    <a class="btn btn-danger btn-sm" href="#">No Payment Slip</a> 
                    @endif  
                        <a class="btn btn-success btn-sm" href="{{url('/admin/spp-'.$spp2->id_pembayaran.'/confirm')}}">Confirm</a>
                        <a class="btn btn-success btn-sm" href="{{url('/admin/spp-'.$spp2->id_pembayaran.'/unconfirm')}}">Decline</a>
                        <a class="btn btn-warning btn-sm" href="{{url('/admin/spp-'.$spp2->id_pembayaran.'/edit')}}">Edit</a>
                        <a class="btn btn-danger btn-sm" href="{{url('/admin/spp-'.$spp2->id_pembayaran.'/delete')}}">Delete</a>
                    </td>
                  </tr>
                @endif
                </tbody>
              ...
              <table class="table table-hover border">
                ...
                @foreach($spp3 as $s)
                  <tr>
                    ...
                    @endif  
                    <a class="btn btn-success btn-sm" href="{{url('/admin/spp-'.$s->id_pembayaran.'/unconfirm')}}">Unconfirm</a>
                        <a class="btn btn-warning btn-sm" href="{{url('/admin/spp-'.$s->id_pembayaran.'/edit')}}">Edit</a>
                        <a class="btn btn-danger btn-sm" href="{{url('/admin/spp-'.$s->id_pembayaran.'/delete')}}">Delete</a>
                    </td>
                  </tr>
                ...
                <tr>
                    ...
                    <a class="btn btn-primary btn-sm" href="#">No Payment Slip</a> 
                    @endif   
                    <a class="btn btn-success btn-sm" href="{{url('/admin/spp-'.$spp3->id_pembayaran.'/unconfirm')}}">Unconfirm</a>
                        <a class="btn btn-warning btn-sm" href="{{url('/admin/spp-'.$spp3->id_pembayaran.'/edit')}}">Edit</a>
                        <a class="btn btn-danger btn-sm" href="{{url('/admin/spp-'.$spp3->id_pembayaran.'/delete')}}">Delete</a>
                    </td>
                  </tr>
                @endif
                </tbody>
          ...
          <a class="btn btn-primary btn-block" href="{{url('/pdfview/'.$siswa->nisn)}}" style="color:white;">Generate report for student {{$siswa->nama}}</a>
        </div>
      </div>
    </div>
                  </div>
