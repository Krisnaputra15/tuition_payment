    ...
    <section class="page-header page-header-text-light bg-secondary">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-8">
            <h1>Edit petugas {{$petugas->nama_petugas}} info</h1>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      @if(Session::has('alert_success'))
        ...
        <ul class="nav nav-tabs justify-content-center mb-4" id="myTab" role="tablist">
          <li class="nav-item"> <a class="nav-link active" >Edit Petugas Info</a> </li>
        </ul>
        <div class="tab-content my-3" id="myTabContent">
          ...
          <form method="post" action="{{url('admin/petugas/edit-process')}}">
            ...
            <div class="form-group">
              ...
              <center><input class="btn btn-primary btn-md" type="submit" value="submit"></center>
            </form>
          </div>
        </div>
      </div>
